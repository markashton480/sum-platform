...
| Branch | Target |
|--------|--------|
| `fix/theme-a-critical-issues/001-audit-issues` | `fix/theme-a-critical-issues` |

```bash
git checkout fix/theme-a-critical-issues
git pull origin fix/theme-a-critical-issues
git checkout -b fix/theme-a-critical-issues/001-audit-issues
git push -u origin fix/theme-a-critical-issues/001-audit-issues
```
