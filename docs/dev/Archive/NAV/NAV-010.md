...
- Use the `nav-popup-design.html` file as a reference for the nested menu design.
- Follow the `design-implementation.md` file for design implementation workflow.
- Ensure the `css-architecure-and-tokens.md` file is updated with the new nested menu styles.
...
- Before implementing, please check the existing navigation implementation.
- `docs/dev/NAV/navigation.md` shows the current navigation structure.
- If in doubt you can check the docs/dev/NAV/ directory for tasks and implementation transcripts to see exactly what was implemented and how.
...
- Update `docs/dev/NAV/navigation.md` to reflect the new nested menu structure.
- Update `docs/dev/NAV/design-implementation.md` to reflect the new nested menu design.
