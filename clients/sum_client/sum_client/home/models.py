"""
Name: SUM Client Home Models
Path: clients/sum_client/sum_client/home/models.py
Purpose: HomePage model for the sum_client project using sum_core features.
Family: Client project consuming sum_core.
Dependencies: Wagtail, sum_core.pages.mixins, sum_core.blocks
"""
...
class HomePage(SeoFieldsMixin, OpenGraphMixin, BreadcrumbMixin, Page):
    """
    Homepage for the sum_client project.

    Demonstrates that client projects can use sum_core mixins and blocks
    as a standalone consumer project.
