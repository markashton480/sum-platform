"""
Name: SUM Client Local Settings
Path: clients/sum_client/sum_client/settings/local.py
Purpose: Local development settings for sum_client.
Family: Client project consuming sum_core.
Dependencies: Django, sum_core
