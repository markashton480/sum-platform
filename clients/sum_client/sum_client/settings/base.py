"""
Name: SUM Client Base Settings
Path: clients/sum_client/sum_client/settings/base.py
Purpose: Shared Django/Wagtail settings for all environments.
Family: Client project consuming sum_core.
Dependencies: Django, Wagtail, sum_core

This file contains settings common to all environments (local, production).
Environment-specific settings are imported from local.py or production.py.
"""
...
# Override this in production.py or via environment variable
SECRET_KEY: str = os.getenv(
    "DJANGO_SECRET_KEY", "sum-client-dev-only-not-for-production"
)
...
ROOT_URLCONF: str = "sum_client.urls"
...
WSGI_APPLICATION: str = "sum_client.wsgi.application"
...
WAGTAIL_SITE_NAME: str = "SUM Client"
