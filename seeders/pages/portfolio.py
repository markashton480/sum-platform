...
class PortfolioPageSeeder(BaseSeeder):
    ...
    def seed(self, content: dict[str, Any], clear: bool = False) -> None:
        ...
        defaults: dict[str, Any] = {
            "title": content.get("title", "Portfolio"),
